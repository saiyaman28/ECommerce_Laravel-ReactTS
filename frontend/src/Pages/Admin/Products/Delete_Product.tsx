        ...
        <Main>
            <Section Title={`Delete Category`} ID={`create-product`}>
                <form onSubmit={handleSubmit}>
                    ...
                    <Inputbox Disabled Title={`Product`} Name={`Product`} Value={form.product_name} OnChange={(e) => setForm({...form, product_name: e.target.value})} Required />
                    <Selectionbox Disabled Title="Category" Name="category_id" Value={form.category_id} OnChange={(e) => setForm({ ...form, category_id: e.target.value, })} Required
                        Options={categories.map((c) => ({
                            Value: c.id,
                            Title: c.category_name,
                        }))}
                    />
                    <Inputbox Disabled Title={`Description`} Name={`Description`} Value={form.description} OnChange={(e) => setForm({...form, description: e.target.value})} />
